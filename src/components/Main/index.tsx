...
const Main: React.FC = () => (
  <Container>
    <WrapperItem>
      ...
      <p>
        Sass is completely compatible with all versions of CSS. We take this compatibility
        seriously, so that you can seamlessly use any available CSS libraries.
      </p>
    </WrapperItem>
    <WrapperItem>
      <span>Feature Rich</span>
      <p>
        Sass boasts more features and abilities than any other CSS extension language out there. The
    ...
    <WrapperItem>
      ...
      <p>
        Sass is actively supported and developed by a consortium of several tech companies and
